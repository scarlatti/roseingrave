  ...
  "validation": {
    "tempo": {
      ...
      "options": [
        ...
        "Andante comodo",
        "Andante è cantabile",
        "Andante moderato è cantabile; Allegro",
        "Andante moderato",
        "Andante spirituoso",
    ...
    "endSignsA": {
      ...
      "options": [
        "",
        "1. – 2.",
        "End double bar with repeat",
        "End double bar without repeat",
        "Fin",
        "Finis",
        "Great curve",
        "Segno",
    ...
    "ornamentTrill": { "type": "boolean" },
    "ornamentPlus": { "type": "boolean" },
    "ornamentTr": { "type": "boolean" },
    "ornamentAcciaccatura": { "type": "boolean" },
    "ornamentAppoggiatura": { "type": "boolean" },
    "ornamentTremulo": { "type": "boolean" }
  },
  "commentFields": {
    "notes": "Notes",
    "comments": "Comments",
